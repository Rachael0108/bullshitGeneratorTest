...
// index.js
var bullshit_generator_js_exports = {};
__export(bullshit_generator_js_exports, {
  default: () => bullshit_generator_js_default
});
module.exports = __toCommonJS(bullshit_generator_js_exports);
...
function generate(title, {
  ...
  const { famous, bosh_before, bosh, said, conclude } = corpus2;
...
if (typeof __dirname === "undefined")
  globalThis.__dirname = (0, import_path.dirname)((0, import_url.fileURLToPath)(import_meta.url));
function loadCorpus(src) {
  const path = (0, import_path.resolve)(__dirname, "..", src);
  const data = (0, import_fs.readFileSync)(path, { encoding: "utf-8" });
